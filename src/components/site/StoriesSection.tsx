  ...
  return (
    <section>
      ...
      <p className="mt-2 max-w-2xl text-black/60">
        Реальні запити людей, які працювали з AI-стилістом PRMPT: що вони
        хотіли змінити, і яке рішення допомогло. Портрети тут — ілюстрації
        (у нас поки немає фотобанку для цієї версії сайту), але історії —
        типові кейси наших користувачів.
      </p>
